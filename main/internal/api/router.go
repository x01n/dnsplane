...
func SetupRouter(staticFS embed.FS) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		auth.Use(middleware.Auth())
		{
			...
			auth.DELETE("/domains/:id", handler.DeleteDomain)
			auth.PUT("/domains/:id", handler.UpdateDomain)
			...
			auth.PUT("/domains/:id/records/:recordId", handler.UpdateRecord)
			auth.DELETE("/domains/:id/records/:recordId", handler.DeleteRecord)
			...
			auth.PUT("/domains/:id/records/batch", handler.BatchEditRecords)
			...
			auth.PUT("/monitor/tasks/:id", handler.UpdateMonitorTask)
			auth.DELETE("/monitor/tasks/:id", handler.DeleteMonitorTask)
			...
			auth.PUT("/cert/accounts/:id", handler.UpdateCertAccount)
			auth.DELETE("/cert/accounts/:id", handler.DeleteCertAccount)
			...
			auth.DELETE("/cert/orders/:id", handler.DeleteCertOrder)
			...
			auth.PUT("/cert/deploys/:id", handler.UpdateCertDeploy)
			auth.DELETE("/cert/deploys/:id", handler.DeleteCertDeploy)
			...
			auth.PUT("/users/:id/permissions/:permId", handler.UpdateUserPermission)
			auth.DELETE("/users/:id/permissions/:permId", handler.DeleteUserPermission)
			...
			auth.DELETE("/cert/cnames/:id", handler.DeleteCertCNAME)
